...
let simpsons = [
    {
        ...
        photo: '<img src="img/Bart_Unlock.png" alt="Bart">'
    },
    {
        name: 'Homer',
        surname: 'Simpson',
        ...
        photo: '<img src="img/homer-simpson_235.jpg" alt="Homer">'
    },
    {
        name: 'Marge',
        surname: 'Simpson',
        ...
        photo: '<img src="img/Marge_Simpson.png" alt="Marge">'
    },
    {
        name: 'Lisa',
        surname: 'Simpson',
        ...
        photo: '<img src="img/Lisa_Simpson.png" alt="Lisa">'
    },
    {
        name: 'Maggie',
        surname: 'Simpson',
        ...
        photo: '<img src="img/Maggie_Simpson.png" alt="Maggie">'
    },
];
    console.log(simpsons);
    for (const simpson of simpsons) {
    document.write(`<div class="simps">
...
let products = [
    {
        title: 'Milk',
        price: 22,
        image: '<img src="img/milk_2pint.png" alt="milk">'
    },
    {
        title: 'Juice',
        price: 27,
        image: '<img src="img/juice.png" alt="juice">'
    },
    {
        title: 'Tomato',
        price: 47,
        image: '<img src="img/Tomato.png" alt="tomato">'
    },
    {
        title: 'Tea',
        price: 15,
        image: '<img src="img/tea.png" alt="tea">'
    },
];
